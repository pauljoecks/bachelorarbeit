...
def data_gen(*args):
    ...
    if x_roi.size == 0 or z_roi.size == 0:
        raise ValueError("No points in ROI - please check for valid points or adjust ROI")        
...
# animation setup
ani = animation.FuncAnimation(fig, update, frames=data_gen, interval=100)
plt.show()
