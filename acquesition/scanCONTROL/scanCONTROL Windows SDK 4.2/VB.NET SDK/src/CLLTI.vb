...
#Region "Constant declarations"
        ...
        Public Const SENSITIVITY_MINIMUM As UInteger = (0 << 3)
        Public Const SENSITIVITY_LOW As UInteger = (1 << 3)
        Public Const SENSITIVITY_MEDIUM As UInteger = (2 << 3)
        Public Const SENSITIVITY_HIGH As UInteger = (3 << 3)
        Public Const SENSITIVITY_MAXIMUM As UInteger = (4 << 3)

        ' Maintenance flags
        Public Const MAINTENANCE_COMPRESS_DATA As UInteger = 1
        ...
        Public Const MULTI_INPUT_PULLUP As UInteger = (0 << 8)
        Public Const MULTI_INPUT_PULLDOWN As UInteger = (1 << 8)
...
#Region "Return Values"
        ...
        Public Const ERROR_POSTPROCESSING_REFLECTION_NUMBER_TOO_HIGH As Integer = -205
        Public Const ERROR_POSTPROCESSING_REFLECTION_NUMBER_NOT_AVAILABLE As Integer = -206
        Public Const ERROR_POSTPROCESSING_INVALID_CONTAINER_RESOLUTION As Integer = -207
        Public Const ERROR_POSTPROCESSING_INCOMPLETE_M0_OR_M1 As Integer = -208
...
#Region "Enums"
        ...
        Public Structure TConvertContainerParameter
            Public Container As IntPtr
            Public profileRearrangement As UInteger
            Public numberOfProfilesToExtract As UInteger
            Public scanner As UInteger
            Public reflectionNumber As UInteger
            Public ConvertToMM As Integer
            Public ReflectionWidth As IntPtr
            Public MaxIntensity As IntPtr
            Public Threshold As IntPtr
            Public Moment0 As IntPtr
            Public Moment1 As IntPtr
            Public X As IntPtr
            Public Z As IntPtr
        End Structure
...
#Region "DLL references"
        ...
        <DllImport(DRIVER_DLL_NAME, CallingConvention:=CallingConvention.StdCall, EntryPoint:="s_ConvertContainer2Values")>
        Shared Function ConvertContainer2Values(pLLT As UInteger, parameter As TConvertContainerParameter) As Integer
        End Function
        ...
        <DllImport(DRIVER_DLL_NAME, CallingConvention:=CallingConvention.StdCall, EntryPoint:="s_FlushContainer")>
        Shared Function FlushContainer(pLLT As UInteger) As Integer
        End Function
