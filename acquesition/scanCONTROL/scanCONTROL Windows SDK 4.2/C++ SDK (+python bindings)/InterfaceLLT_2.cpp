...
CInterfaceLLT::CFunctions::CFunctions(const char* pDLLName /*= "LLT.dll"*/, bool* pLoadError /*=NULL*/)
{
  ...
  ConvertContainer2Values = reinterpret_cast<decltype(&s_ConvertContainer2Values)>(m_pDllLoader->GetFunction("s_ConvertContainer2Values"));
...
int
CInterfaceLLT::ConvertContainer2Values(TConvertContainerParameter param)
{
	return m_pFunctions->ConvertContainer2Values(m_DeviceHandle, param);
}
